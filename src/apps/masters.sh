...
./hpart ${FILE_NAME}_sparse_matrix_cm.txt > ${FILE_NAME}_sparse_matrix_cm_parts.txt
...
./hpart ${FILE_NAME}_sparse_matrix_rcm.txt > ${FILE_NAME}_sparse_matrix_rcm_parts.txt
...
./hpart ${FILE_NAME}_sparse_matrix_mts.txt > ${FILE_NAME}_sparse_matrix_mts_parts.txt
