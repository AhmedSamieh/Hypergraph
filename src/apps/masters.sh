...
./hpart ${FILE_NAME}_sparse_matrix_cm.txt 5.0 5.0 1.0 > ${FILE_NAME}_sparse_matrix_cm_parts.txt
...
./hpart ${FILE_NAME}_sparse_matrix_rcm.txt 5.0 5.0 1.0 > ${FILE_NAME}_sparse_matrix_rcm_parts.txt
...
./hpart ${FILE_NAME}_sparse_matrix_mts.txt 4.0 40.0 1.0 > ${FILE_NAME}_sparse_matrix_mts_parts.txt
